 ...
 *@Description: 后台GII增删查改控制器模板
 *Version: V1.0.0
 *@Author: zenglinbo
 *@Email: 149407284@qq.com
 *@Date: 2021-04-26 14:40:36
 *@LastEditors: 
 *@LastEditTime: 
*/
...
class <?= $controllerClass ?> extends Controller
{
     ...
     * - item group=未分类 category=<?= $category ?> description=创建 sort-get=001 sort-get=002 method=get,post
     ...
     public function actions()
     {
         ...
         return [
            ...
            'update' => [
                ...
                'doUpdate' => function(<?php if (!empty($closureIdParam)) {echo $closureIdParam;echo ", ";} ?>
                                        $postData, $updateAction) use($service) {
            ...
            'delete' => [
                ...
                <?php if(!empty($idSign)) echo $idSign; ?>
                'doDelete' => function(<?php if (!empty($closureIdParam)) {echo $closureIdParam;echo ", ";} ?>
                                        $deleteAction) use($service){
